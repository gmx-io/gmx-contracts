...
async function main() {
  ...
  // signal revoke permissions for rewardRouter
  multicallWriteParams.push(timelock.interface.encodeFunctionData("signalSetMinter", [bnGmx.address, rewardRouter.address, false]));
  multicallWriteParams.push(timelock.interface.encodeFunctionData("signalSetHandler", [feeGmxTracker.address, rewardRouter.address, false]));

  // signal grant permissions for rewardRouter
  multicallWriteParams.push(timelock.interface.encodeFunctionData("signalSetMinter", [bnGmx.address, rewardRouter.address, true]));
  multicallWriteParams.push(timelock.interface.encodeFunctionData("signalSetHandler", [feeGmxTracker.address, rewardRouter.address, true]));

  // signal grant permissions for vester cap
  multicallWriteParams.push(timelock.interface.encodeFunctionData("signalSetMinter", [esGmx.address, vesterCap.address, true]));
  multicallWriteParams.push(timelock.interface.encodeFunctionData("signalSetHandler", [gmxVester.address, vesterCap.address, true]));
  multicallWriteParams.push(timelock.interface.encodeFunctionData("signalSetHandler", [feeGmxTracker.address, vesterCap.address, true]));
