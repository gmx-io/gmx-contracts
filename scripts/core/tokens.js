...
module.exports = {
  ...
  arbitrum: {
    ...
    eth: {
      ...
      tokenWeight: 28000,
      minProfitBps: 0,
      maxUsdgAmount: 170 * 1000 * 1000,
      bufferAmount: 60000,
      isStable: false,
      isShortable: true,
      maxGlobalLongSize: 72 * 1000 * 1000,
      maxGlobalShortSize: 36 * 1000 * 1000,
      openInterestLimitLong: 110 * 1000 * 1000,
      openInterestLimitShort: 70 * 1000 * 1000,
      maxOpenInterestLong: 90 * 1000 * 1000,
