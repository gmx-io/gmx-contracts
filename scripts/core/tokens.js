...
module.exports = {
  ...
  arbitrum: {
    btc: {
      ...
      minLiquidityThresholdShort: 1 * 1000 * 1000
    },
    eth: {
      name: "eth",
  ...
  avax: {
    ...
    eth: {
      ...
      maxOpenInterestLong: 8 * 1000 * 1000,
